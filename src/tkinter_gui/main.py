...
try:
    ...
    entry_place.grid(row=0, column=1, columnspan=1, sticky="W", padx=(0, 10), pady=10)
    ...
    label_place_1.grid(row=4, column=0, columnspan=2, sticky="NSEW", padx=10, pady=10)
    ...
    label_place_2.grid(row=4, column=0, columnspan=2, sticky="NSEW", padx=10, pady=10)
    ...
    win.bind("<Configure>", lambda event: maintain_aspect_ratio(event, WIDTH / HEIGHT))
    win.state("zoomed")
    win.mainloop()
